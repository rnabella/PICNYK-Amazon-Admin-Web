...
WebUI.verifyElementVisible(findTestObject('Timesheets/input_Date Range  Pay Period_dob'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Timesheets/button_Apply Date Range'))
